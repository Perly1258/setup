...
# This data string reflects the Fund_ID, Vintage_Year, and commitment from your PE_Portfolio.csv 
# The commitment values are now correctly scaled to absolute USD internally for simulation.
DATA_STRING = """
